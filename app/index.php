...
<head>
    ...
    <link rel="stylesheet"
          href="https://dev.1c-bitrix.ru/bitrix/js/ui/progressbar/ui.progressbar.min.css?16655106043702">
    ...
    <link rel="stylesheet" href="https://skyweb24.ru/bitrix/js/ui/icon-set/main/style.min.css">
    <link rel="icon" href="./favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="<?= HelperFileVersion::get('/app/dist/content.bundle.css') ?>">
...
<script src="<?= HelperFileVersion::get('/app/dist/content.bundle.js') ?>"></script>
